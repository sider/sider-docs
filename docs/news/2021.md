...
| [RuboCop](../tools/ruby/rubocop.md)             | Ruby         | 1.11.0 → **1.12.0** | [changes](https://github.com/rubocop-hq/rubocop/blob/v1.12.0/CHANGELOG.md)                               |
...
- [`npm_install: "development"`](../getting-started/custom-configuration.md#linteranalyzer_idnpm_install) is deprecated.
  Instead, [`dependencies`](../getting-started/custom-configuration.md#linteranalyzer_iddependencies) may be an alternative.
- The deprecated `options` option is removed. See each tool document for details.
