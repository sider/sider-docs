...
## Recommended ruleset for cpplint and more

<time class="news-date" datetime="2020-10-07">October 7, 2020</time>

Sider will release our recommended ruleset for cpplint in mid October 2020. Prior to the release, the notification message will be shown on the Tools tab if the cpplint configuration file `CPPLINT.cfg` doesn't exist in your repository.

In addition, this release includes the following updates:

- **ESLint** The ESLint plugin for Vue.js [`eslint-plugin-vue`](https://github.com/vuejs/eslint-plugin-vue/releases/tag/v7.0.0) is added to the default package list.
- **RuboCop** Some [cops](https://github.com/sider/runners/pull/1506/files#diff-2d8efbdb905f4de38c35365f48a62992) are added to the optional gem list.
