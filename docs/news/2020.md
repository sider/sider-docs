...
This tool is a "Copy/Paste Detector" to finding duplicated code in multiple languages like Java, Ruby, Python, and any more.
...
- Kotlin
  - [detekt](../tools/kotlin/detekt.md) - 1.8.0 to **1.9.1** ([release note](https://detekt.github.io/detekt/changelog.html#191))
- Ruby
...
- PHP
  - [PHP_CodeSniffer](../tools/php/code-sniffer.md) - 3.5.4 to **3.5.5** ([release note](https://github.com/squizlabs/PHP_CodeSniffer/releases/tag/3.5.5))
- Ruby
...
- PHP
  ...
  - [PHP_CodeSniffer](../tools/php/code-sniffer.md) - 3.5.2 to **3.5.3** ([changes](https://github.com/squizlabs/PHP_CodeSniffer/releases/tag/3.5.3))
- Ruby
