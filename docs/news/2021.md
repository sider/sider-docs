...
In addition, this update includes the following notable change: 💥

- Support [`suppressions-list`](../tools/cplusplus/cppcheck.md#suppressions-list) option for Cppcheck - This option allows you to specify a file path of a suppressions file. This helps you filter out certain rules from being generated.
