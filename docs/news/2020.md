...
The version change is from 1.19.4 to **1.20.0**. Here is the [changelog](https://github.com/flyerhzm/rails_best_practices/blob/master/CHANGELOG.md#1200-2020-02-29).
