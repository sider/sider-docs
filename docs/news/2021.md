...
- Add the [`linter.flake8.parallel`](../tools/python/flake8.md#parallel) option.
- Add the [`linter.detekt.target`](../tools/kotlin/detekt.md#target) and [`linter.detekt.parallel`](../tools/kotlin/detekt.md#parallel) options.
