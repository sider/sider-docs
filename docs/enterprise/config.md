...
sideci, which is a core component of Sider Enterprise, will invoke Runners to perform analyses. The parameters in this section control how Sider should invoke Runners, and how the traces generated by Runners should be stored. See [Minio Guiode](./minio.md) for the set up of Minio.
