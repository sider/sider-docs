...
It allows you to save more time excluding useless files for analysis (such as `bundle.min.js`) via the [`ignore`](../getting-started/custom-configuration.md#ignore) option of `sider.yml`. ⚡️️
