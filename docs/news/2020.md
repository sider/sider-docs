...
## Update environments and tools on November 2, 2020
...
- In the context of [Python 2 end of life](https://www.python.org/doc/sunset-python-2/) on January 1, 2020, we drop the support of Python 2 accordingly.
...
- Go
  - [GolangCI-Lint](../tools/go/golangci-lint.md) - 1.31.0 → **1.32.0** ([release note](https://github.com/golangci/golangci-lint/releases/tag/v1.32.0))
- Java
