...
<time class="news-date" datetime="2021-03-0x">March x, 2021</time>

- Add the options for [Flake8](../tools/python/flake8.md#configuration):
  - `linter.flake8.parallel` added
- Add the options for [detekt](../tools/kotlin/detekt.md#configuration):
  - `linter.detekt.target` added
  - `linter.detekt.parallel` added
- Add and change the options for [PHP_CodeSniffer](../tools/php/code-sniffer.md#configuration):
  - `linter.code_sniffer.target` added
  - `linter.code_sniffer.parallel` addeed
  - `linter.code_sniffer.standard` changed (also allowing `string[]`)
