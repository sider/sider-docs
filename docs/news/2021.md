...
Please check out ["Recommended Ruleset"](../getting-started/recommended-rules.md) for more details about our recommended rulesets.
...
- Add and change the options for [PHP_CodeSniffer](../tools/php/code-sniffer.md#configuration):
  - `target` added
  - `parallel` addeed
  - `standard` changed (also allowing `string[]`)
