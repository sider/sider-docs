...
## Update environments and tools on December 14, 2020

<time class="news-date" datetime="2020-12-14">December 14, 2020</time>

We have updated the following environments and tools. Please read each tool's documentation for details.

Environment:

- Debian - buster-20201012 → **buster-20201117**
- Go - 1.15.3 → **1.15.6**
- Gradle - 6.7 → **6.7.1**
- Java - 14.0.2 → **15.0.1**
...
- JavaScript
  ...
  - [ESLint](../tools/javascript/eslint.md) - 7.12.1 → **7.14.0** ([release note](https://eslint.org/blog/2020/11/eslint-v7.14.0-released))
- Ruby
  - [RuboCop](../tools/ruby/rubocop.md) - 1.0.0 → **1.5.2** ([changelog](https://github.com/rubocop-hq/rubocop/blob/v1.5.2/CHANGELOG.md#152-2020-12-04))
- Swift
...
<time class="news-date" datetime="2020-11-30">November 30, 2020</time>
