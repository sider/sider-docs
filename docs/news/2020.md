...
## Update environments and tools on September 18, 2020

<time class="news-date" datetime="2020-09-18">September 18, 2020</time>

We have updated the following environments and tools. Please each tool's document for details.

Highlight:

- TBD Allow $RUNNER_USER to add certificate files #284
- TBD Cppcheck Run multiple threads with the -j option #1462
- TBD RuboCop Add standard to optional gem list #1479
- TBD RuboCop Improve warning messages #1480
- TBD Make generated Gemfile content log valid as Ruby #1485
- TBD SwiftLint params files #499
