...
<time class="news-date" datetime="2020-07-1x">July 1x, 2020</time>

We are happy to announce that [Clang-Tidy](../tools/cplusplus/clang-tidy.md) is newly supported! 🎉

Clang-Tidy is a part of the [Clang](https://clang.llvm.org/) toolchain, and it can detect style violations or common bugs, etc. in C/C++ code.
