...
## Python2 EOL and environments/tools update

<time class="news-date" datetime="2020-11-02">November 2, 2020</time>

We have updated the following environments and tools. Please read each tool's documentation for details.

Highlight:

- As announced [earlier](https://blog.sider.review/drop-the-support-for-python-2-at-the-end-of-october-2020-68d2748545c9), we drop the support for Python 2.
- As announced [earlier](#recommended-ruleset-for-cpplint), our recommended ruleset for cpplint is now enabled. See our [cpplint document](../tools/cplusplus/cpplint.md#recommended-ruleset) for details.
- The [`parallel`](../tools/ruby/haml-lint.md#parallel) option of HAML-Lint is newly supported. This option allows you to run linters in parallel.
...
- Java
  ...
  - [JavaSee](../tools/java/javasee.md) - 0.1.3 → **0.2.0** ([release note](https://github.com/sider/JavaSee/releases))
