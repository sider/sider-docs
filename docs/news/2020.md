...
This tool can detect programming errors, help to enforce a coding standard, sniff for code smells and offer simple refactoring suggestions in Python files, so it will surely help your code-review.
